...
OLAP_RULES = [
 ...
 ("Large Blend",["SPY","VOO","IVV","VTI","ITOT","SCHB","IWB","DFAC","AVUS","SPLG","DFAU","OEF","DYNF","QUAL","USMV","MTUM","JEPI","GQGU"],["large blend","total stock market","s&p 500","core equity","russell 1000","large cap core","large-cap core","large cap blend","large-cap blend","msci usa","enhanced large","broad market","u.s. large cap","us large cap","u.s. large-cap","us large-cap","large cap equity","mega cap","mega-cap","russell top 200","momentum factor","quality factor","morningstar u.s. equity","wide moat","moat etf","market factor tilt","blue chip","dow jones industrial","dow jones u.s.","betabuilders u.s. equity","u.s. quality","us quality","quality large cap","kld 400","quantitative momentum","large company","russell 3000","s&p 1500","select 500","transform 500","strive 500","essential 40","motley fool 100","capital strength","research enhanced","fundamental u.s. large","fundamental us large","top 20 u.s","nasdaq top","rafi us 1000","u.s. multifactor","us multifactor","u.s. factor","multifactor us equity","u.s. equity index","u.s. equity research","us equity market","u.s. equity strategy","select u.s. equity","ftse usa"]),   # 'betabuilders u.s.' made contiguous '…u.s. equity' — the bare form stole BetaBuilders U.S. Small/Mid Cap + Aggregate Bond   # JEPI = S&P equity + covered calls  ·  'momentum/quality factor' kept (guarded by 'intl … factor' below); bare 'multifactor'/'equity factor' NOT keyworded — they beat 'small-cap'(9)/'international'(13) and steal small-cap & foreign factor funds
 ("Large Value",["VTV","IVE","IWD","SCHV","SCHD","DGRO","VIG","DFAV","VLUE","QDF","QDEF","DIVB"],["large value","dividend equity","dividend appreciation","high dividend","large cap value","mega cap value","value factor","dividend multiplier","rising dividend","dividend leaders","dividend achievers","superdividend","strategic dividend","s&p dividend","morningstar value","quantitative value","u.s. value","us value","marketwide value","dynamic value","value line dividend","largecap dividend","total dividend","shareholder yield","u.s. core dividend"]),   # 'large cap value'/'value factor' guarded by 'international … value' below.  'select/core/quality/sector dividend' + 'dividend growth/growers' NOT keyworded — long dividend phrases beat 'international'(13)/'small-cap'(9) and steal foreign & small-cap dividend funds; only NON-colliding dividend phrases kept
 ("Mid-Cap Growth",["VOT","IWP","MDYG"],["mid cap growth","mid-cap growth","smid growth"]),
 ("Mid-Cap Blend",["VO","IJH","IWR","SCHM"],["mid cap blend","mid-cap blend","mid cap core","mid-cap core","midcap","s&p midcap","mid-cap","mid cap equity","u.s. mid cap","us mid cap","small-mid cap","small/mid cap","s&p 400","smid core","smid cap","small and mid cap","russell 2500","extended market","enhanced mid cap","small-mid multifactor","small & mid cap"]),   # bare 'small mid cap' dropped — ties 'mid cap value'(13) and flips value funds to blend
...
EXTRA = [  # (code, tickers, name-keywords)
 ...
 ("MULTI_ASSET",["BCAT"],["capital allocation","multi-asset","multi asset","balanced allocation","flexible allocation","moderate allocation","core balanced"]),   # BCAT = BlackRock Capital Allocation Term Trust
