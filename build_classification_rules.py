...
OLAP_RULES = [
 ...
 ("Large Growth",["VUG","QQQ","QQQM","IWF","SCHG","SPYG","VOOG","IVW"],["large growth","large cap growth","large-cap growth","nasdaq 100","nasdaq-100","mega cap growth","mega-cap growth","russell top 200 growth","quality growth","morningstar growth","blue chip growth"]),
 ("Large Blend",["SPY","VOO","IVV","VTI","ITOT","SCHB","IWB","DFAC","AVUS","SPLG","DFAU","OEF","DYNF","QUAL","USMV","MTUM","JEPI"],["large blend","total stock market","s&p 500","core equity","russell 1000","large cap core","large-cap core","large cap blend","large-cap blend","msci usa","enhanced large","broad market","u.s. large cap","us large cap","u.s. large-cap","us large-cap","large cap equity","mega cap","mega-cap","russell top 200","momentum factor","quality factor","morningstar u.s. equity","wide moat","moat etf","market factor tilt","blue chip","dow jones industrial","dow jones u.s."]),   # JEPI = S&P equity + covered calls  ·  'momentum/quality factor' kept (guarded by 'intl … factor' below); bare 'multifactor'/'equity factor' NOT keyworded — they beat 'small-cap'(9)/'international'(13) and steal small-cap & foreign factor funds
 ("Large Value",["VTV","IVE","IWD","SCHV","SCHD","DGRO","VIG","DFAV","VLUE"],["large value","dividend equity","dividend appreciation","high dividend","large cap value","mega cap value","value factor","dividend multiplier","rising dividend","dividend leaders","dividend achievers","superdividend","strategic dividend","s&p dividend","morningstar value"]),   # 'large cap value'/'value factor' guarded by 'international … value' below.  'select/core/quality/sector dividend' + 'dividend growth/growers' NOT keyworded — long dividend phrases beat 'international'(13)/'small-cap'(9) and steal foreign & small-cap dividend funds; only NON-colliding dividend phrases kept
 ...
 ("International",["VXUS","IEV","VEU","ACWX"],["international","developed markets","europe","global dividend","global equity","global stock market","global select equity","global 100","global value","islamic world"]),
 ...
 ("Equity Energy",["XLE","VDE","IYE"],["energy sector","equity energy","clean energy","solar","renewable energy","uranium","nuclear energy","oil & gas","oil and gas","midstream","clean power","green energy","clean edge","hydrogen","mlp etf"]),
 ("Equity Precious Metals",["GDX","GDXJ","RING"],["equity precious metals","gold miners"]),
 ("Industrials",["XLI","VIS","IYJ","PWRD","NASA"],["industrials sector","aerospace","defense etf","airlines","defense tech","aerospace & defense","space tech","defense industry","transportation"]),   # PWRD = energy-transition; NASA = space economy / aerospace (FMP)
 ("Infrastructure",["IGF","PAVE","IFRA"],["infrastructure"]),
 ("Natural Resources",["IGE","GNR","NANR","REMX"],["natural resources","rare earth","strategic metals","materials","basic materials","metals & mining","metals and mining","copper miners","mining producers","lithium"]),
 ...
 ("Financial",["XLF","VFH","IYF"],["financial sector","regional bank","capital markets","bank etf","s&p bank","insurance"]),
 ...
 ("Core / Multisector Bonds",["BND","AGG","BNDX","IUSB","SCHZ","JPIE","FLXR","VWOB","BIV","MBB","VMBS","GNMA","CLOA"],["bond","fixed income","aggregate","flexible income","income etf","multisector","universal","collateralized loan","ultrashort","ultra short","ultrasho","short duration income","emerging markets bond","emerging market bond","emerging markets debt","emerging markets fixed","emerging markets local","emerging markets sovereign","emerging markets corporate","sukuk"]),   # P3-15: dropped bare 'clo' (matched CLOSED-END etc.); CLOA pinned by ticker  ·  EM-debt compounds beat bare 'emerging markets' so EM bonds stay bonds
