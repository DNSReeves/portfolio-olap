...
OLAP_RULES = [
 ...
 ("Equity Energy",["XLE","VDE","IYE"],["energy sector","equity energy","clean energy","solar","renewable energy","uranium","nuclear energy","oil & gas","oil and gas","midstream","clean power","green energy","clean edge","hydrogen","mlp etf","global energy","msci energy","wind energy"]),
 ...
 ("Core / Multisector Bonds",["BND","AGG","BNDX","IUSB","SCHZ","JPIE","FLXR","VWOB","BIV","MBB","VMBS","GNMA","CLOA"],["bond","fixed income","aggregate","flexible income","income etf","multisector","universal","collateralized loan","ultrashort","ultra short","ultrasho","short duration income","emerging markets bond","emerging market bond","emerging markets debt","emerging markets fixed","emerging markets local","emerging markets sovereign","emerging markets corporate","sukuk","mortgage-backed","mortgage backed"]),   # P3-15: dropped bare 'clo' (matched CLOSED-END etc.); CLOA pinned by ticker  ·  EM-debt compounds beat bare 'emerging markets' so EM bonds stay bonds
