...
_SELFTEST = [
    ...
    # 2026-07-05: round-8 hard-tail — a handful of clear Morningstar homes
    ("ZAVGE", "AVANTIS ALL EQUITY MARKETS ETF", "INTERNATIONAL"),                 # all-equity-markets (global) → International
    ("ZMSOS", "ADVISORSHARES PURE US CANNABIS ETF", "HEALTH"),                    # cannabis → Health
